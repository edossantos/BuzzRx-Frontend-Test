  ...
  <div class="drug-options-view">
    ...
    <div class="drug-options-tabs">
      ...
      <tab
        tabTitle="Strength"
        :tabSelectedValue="
          selectedDrugStrength ? selectedDrugStrength.strength : ''
        "
      ...
      <tab
        tabTitle="Quantity"
        :tabSelectedValue="
          selectedDrugQuantity ? selectedDrugQuantity.quantity.toString() : ''
        "
...
export default {
  ...
  activated() {
    if (this.$route.query.drugName && this.$route.query.drugType) {
      console.log('state: ');
      this.getDrugOptions({
        name: this.$route.query.drugName,
        drug_type: this.$route.query.drugType,
      });
    } else {
  ...
  methods: {
    ...
    showSavings() {
      this.getDrugPrices().then(() =>
        this.$router.push({ name: 'drug_prices' })
      );
    },
  },
};
