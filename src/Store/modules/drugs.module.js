...
const getters = {
  ...
  getSelectedDrugNameOption: state => state.selectedDrug.drug_names.filter(drugName => drugName.drug_type == state.selectedDrug.type)[0],
  getSelectedDrugNameList: state => state.selectedDrug.drug_names,
  getSelectedDrugNameListLength: state => state.selectedDrug.drug_names.length,
  getSelectedDrugForm: state => state.selectedDrug.drug_form.find(drugForm => drugForm.select == true),
  ...
  getSelectedDrugStrength: state => state.selectedDrug.drug_strength.find(drugStrength => drugStrength.select == true),
  getSelectedDrugStrengthList: state => state.selectedDrug.drug_strength,
  getSelectedDrugStrengthListLength: state => state.selectedDrug.drug_strength.length,
  getSelectedDrugQuantity: state => state.selectedDrug.drug_quantity.find(drugQuantity => drugQuantity.select == true),
  getSelectedDrugQuantityList: state => state.selectedDrug.drug_quantity,
  getSelectedDrugQuantityListLength: state => state.selectedDrug.drug_quantity.length,
...
const mutations = {
  SET_SELECTED_DRUG_NAME: (state, payload) => state.selectedDrug.name = payload,
  SET_SELECTED_DRUG_TYPE: (state, payload) => state.selectedDrug.type = payload,
  SET_SELECTED_DRUG_NAMES: (state, payload) => {
    const brandDrugName = payload.drug_names.brand.map(name => [{label: `${name} (Brand)`, selected: payload.drug_type == 'B' ? true : false, drug_type: 'B', name: payload.name } ]);
    const GenericDrugName = payload.drug_names.generic.map(name => [{label: `${name} (Generic)`, selected: payload.drug_type == 'G' ? true : false, drug_type: 'G', name: payload.name }]);
    state.selectedDrug.drug_names = [...brandDrugName[0], ...GenericDrugName[0]]
  },
  SET_SELECTED_DRUG_FORMS: (state, payload) => state.selectedDrug.drug_form = payload,
  ...
  SET_SELECTED_DRUG_STRENGTH: (state, payload) => state.selectedDrug.drug_strength = payload,
  ...
  SET_SELECTED_DRUG_QUANTITY: (state, payload) => state.selectedDrug.drug_quantity = payload,
  ...
  SET_SELECTED_DRUG_PRICES: (state, payload) => state.selectedDrug.drug_prices = payload
}
